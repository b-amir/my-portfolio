    ...
    <div className={styles.heroTexts}>
      ...
      <h2 className={styles.heroSubtitle}>
        ...
        <Tooltip
          text={
            <div>
              A while back, I came across an interview where a renowned chef was
              ...
              <blockquote>
                ...
                with mixed results, a chef can be given a basket of ingredients
                and is able to create something wonderful.&quot;
              </blockquote>
              <br />
